# Security Module for CV-Tailor
#
# Creates IAM roles and Security Groups for all infrastructure components.
#
# Components:
...
# ECS Task Role
# ============================================================================
# This role is used by the application running in ECS
...
# Policy for S3 access (media and static files)
    ...
    Statement = [
      {
        ...
        Resource = [
          ...
          "arn:aws:s3:::${var.s3_media_bucket}",
          "arn:aws:s3:::${var.s3_static_bucket}/*",
          "arn:aws:s3:::${var.s3_static_bucket}"
        ]
      }
    ]
...
resource "aws_security_group" "ecs_tasks" {
  ...
  # Allow all outbound (for pulling images, accessing RDS, Redis, etc.)
  egress {
    description = "Allow all outbound"
    from_port   = 0
    to_port     = 0
